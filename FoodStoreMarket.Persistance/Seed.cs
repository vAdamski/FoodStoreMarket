    ...
    public static class Seed
    {
                ...
                ps.HasMany(ps => ps.Ingredients)
                    ...
                    .UsingEntity(j => j.ToTable("IngredientProductSpecification")
                        .HasData(new[]
                            {
                                //PIZZA #1
                                new {IngredientsId = 1, ProductSpecificationId = 1},
                                new {IngredientsId = 2, ProductSpecificationId = 1},
                                //PIZZA #2
                                new {IngredientsId = 1, ProductSpecificationId = 2},
                                new {IngredientsId = 2, ProductSpecificationId = 2},
                                new {IngredientsId = 3, ProductSpecificationId = 2},
                                new {IngredientsId = 4, ProductSpecificationId = 2},
                                new {IngredientsId = 5, ProductSpecificationId = 2},
                                //PIZZA #2
                                new {IngredientsId = 1, ProductSpecificationId = 3},
                                new {IngredientsId = 2, ProductSpecificationId = 3},
                                new {IngredientsId = 4, ProductSpecificationId = 3},
                                new {IngredientsId = 6, ProductSpecificationId = 3},
                            }));
            });
        }
        ...
        private static void SeedRestaurantSpecification(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<RestaurantSpecification>(rs =>
            {
                ...
                rs.OwnsOne(rs => rs.Adres).HasData(new Adres()
                {
                    City = "Lodz",
                    PostCode = "94-000",
