...
public class EditProductSpecificationHandler : IRequestHandler<EditProductSpecificationCommand, bool>
{
    ...
    public EditProductSpecificationHandler(IFoodStoreMarketDbContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }

    public async Task<bool> Handle(EditProductSpecificationCommand request, CancellationToken cancellationToken)
    {
        try
        {
